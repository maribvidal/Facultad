...
public static class UtilityClass
{
    ...
    public static TimeSpan GetTimeSpan()
    {
        ...
        int minutos = GetNumber(60);
        Console.Write("SEGUNDOS: ");
        int segundos = GetNumber(60);
        Console.Write("MILISEGUNDOS: ");
        int milisegundos = GetNumber(999);

        return new TimeSpan(0, 0, minutos, segundos, milisegundos);
    }

...
procedure cargarVector(var v: vector; var dimL, c, e1, e2: integer; var n1, n2, a1, a2: string); //Cargar el vector de alumnos
    var
        i: integer;
    begin
        i:= 1;
        leerAlumno(v[i]);
        while (v[i].DNI <> -1) and (dimL <= sizelimit) do begin
...
var
    v: vector;
    dimL, cantDNIPares, edadMax, edadMax2: integer;
...
begin 
    ...
    //Programa principal
    cargarVector(v, dimL, cantDNIPares, edadMax, edadMax2, nombreMax, nombre2Max, apellidoMax, apellido2Max);
    porcentajeDNIPares:= (cantDNIPares / dimL)*100;

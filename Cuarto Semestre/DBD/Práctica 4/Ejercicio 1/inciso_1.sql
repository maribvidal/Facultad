-- probarlo en https://sqlfiddle.com/mysql/online-compiler?id=46e93f36-547f-4e16-ac0b-6736383d534f
-- INIT database
...
('T001', '870', '2024-10-20', '10:30', 'C001'),
('T002', '170', '2024-10-21', '14:45', 'C002'),
('T003', '50', '2024-10-22', '16:15', 'C003'),
('T004', '950', '2024-10-23', '11:20', 'C004'),
('T005', '340', '2024-10-24', '09:50', 'C005');
...
-- QUERY database
SELECT nombre, apellido, DNI, telefono, direccion FROM cliente WHERE (cliente.apellido LIKE 'Pe%') ORDER BY dni
